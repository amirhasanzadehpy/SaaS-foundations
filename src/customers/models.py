...
from helpers.billing import create_custom_user
from allauth.account.signals import email_confirmed as allauth_email_confirmed, user_signed_up as allauth_user_signed_up
        ...
        if not self.stripe_id:
            if self.init_email_confirmed and self.init_email:
                ...
                if email != "" or email is not None:
                    stripe_id = create_custom_user(email=email,metadata={
